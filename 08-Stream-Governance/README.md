...
- [schema-evolution.md](schema-evolution.md) — Wire format, compatibility modes and upgrade sequencing, safe vs breaking changes in Avro and Protobuf, subject naming strategies, and registry best practices.
