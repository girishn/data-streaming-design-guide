...
- [confluent-cloud-metrics-api.md](confluent-cloud-metrics-api.md) — REST-based metrics for Confluent Cloud clusters, connectors, and Flink; authentication, query patterns, cost showback/chargeback by team, and how it differs from JMX for self-managed clusters.
- [datadog-integration.md](datadog-integration.md) — Datadog integration for Confluent Cloud: MetricsViewer role setup, API key scoping (critical gotcha), /export and /discovery endpoints, metric namespaces, alert thresholds for consumer lag/connectors/Flink/cluster health, dashboard structure, and Health+ vs Datadog decision.
