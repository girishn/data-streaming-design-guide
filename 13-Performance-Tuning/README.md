...
- [capacity-scaling-cadence.md](capacity-scaling-cadence.md) — The repeatable resize cycle for compounding growth (e.g. 10x every 6 months): monitoring triggers, which layer to resize (broker/CKU vs. partitions vs. quotas) and on what cadence, and the tier/architecture thresholds a growth cycle can force.
