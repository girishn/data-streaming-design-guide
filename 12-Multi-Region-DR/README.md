...
- [mirrormaker2.md](mirrormaker2.md) — MirrorMaker 2 architecture as a Kafka Connect framework, offset translation, consumer group migration via `sync.group.offsets.enabled`, and operational tradeoffs.
