...
- [testing-strategy.md](testing-strategy.md) — Four testing layers for streaming applications: `TopologyTestDriver` unit tests and their single-partition limitation, Testcontainers integration tests, consumer-driven contract testing for cross-team topics, and automated post-deploy acceptance/soak testing.

For a worked example applying the onboarding gates and automation pyramid above at platform scale (hundreds of teams, 1,500–3,000 topics) — see [14-Case-Studies/logistics-platform-engineering-gcp.md](../14-Case-Studies/logistics-platform-engineering-gcp.md).
